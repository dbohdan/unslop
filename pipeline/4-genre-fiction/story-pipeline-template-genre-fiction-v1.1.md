# Genre Fiction Short Story Pipeline — Claude Projects Template (v1.1)
...
If the strangest moves you name include any document-form examples (catalogue, dossier, encyclopedia entry, transcript, manual, register, correspondence, ledger, after-action, deposition), at least one of your other strangest-moves must be in a non-document register — a parable-compression, a deep-time montage, an ontological reframe rendered in close-third, an impossible-object encounter, an irruption, a world-where-the-protagonist-is-a-process, a scale-shift, or a comparable non-document strange move. The micro-example for that non-document move must also be in a non-document register: a paragraph of montage prose compressing a century, a paragraph of close-third prose where the protagonist is not a person, a paragraph of irruption prose where the world breaks open. Document forms are over-represented in the writer-model's working repertoire; the section should reach beyond them, both in what it names and in what it writes.
...
If you notice three or more candidates clustering along any axis, break the cluster deliberately by pushing later candidates to the edges of that axis. Plot #20 should not feel like a sibling of plot #1. Particular attention to clustering on *form*: under this template, the failure mode is not too many narrative scenes (they are the genre's center) but too many of the same non-narrative-scene form. If 6 of the 20 plots are dossiers, that's a cluster; if 5 of the 8 non-narrative-scene plots are document forms (catalogue, dossier, encyclopedia, transcript, manual, register, correspondence, after-action), that's a cluster too — break it by pushing some of those plots toward non-document strange forms (parable-compression, deep-time montage, ontological reframe, irruption, world-as-process).
...
If candidates are clustering on the most familiar option for the given form (chronological close-third for narrative-scene, alphabetical-complete for catalogue), deliberately push some toward less comfortable shapes.
...
*Narrative scene:* "Scene 3 (≈400 words): the first-tier engineer arrives at the substation. The relays are mid-cascade. She has eleven minutes before the next pulse triggers. Ends on her opening the manual override panel and finding the seal already broken."
...
4. **Audit the draft in one pass**, watching for all of the following:
   ...
   - **Legibility failures** in the form's terms (see the Legibility Floor in Setup): missing connective tissue inside a narrative scene; missing organizational consistency inside a catalogue; orphaned references inside a dossier; insufficiently-signalled compressions inside a montage. The legibility floor is form-relative, not prose-uniform.
...
**What this template is for.** Genre Fiction v1.1 produces plot-focused genre fiction in a user-specified speculative genre. It does not produce literary realism in a speculative setting. If a run consistently wants to produce literary-realist work — a story whose engine is a character's interior recognition, with the speculative element as setting — that's a sign the template is being used for something it's not for. Use a different template, or use this one and accept that it will resist your taste.
...
**Narrative scene as the genre's center; the document attractor.** v1.0 of this template treated narrative-scene forms and non-narrative-scene forms as coequal options on the form axis, with a soft floor of three non-narrative-scene plots out of twenty. In testing, this calibration over-promoted strange-tail forms — and within strange-tail forms, over-promoted document forms specifically (catalogues, dossiers, correspondences, ledgers, after-actions). The writer-model has the strongest reference material for institutional and epistolary documents, and reaches for them whenever told to produce non-realist forms. Across four runs of v1.0 in different genres, all four winning stories were document-shaped. v1.1 restores the genre's center: narrative scenes are the default for most genres, with at least 12 of 20 Plot-premise plots committed to that form. Non-narrative-scene forms remain available, but they have to earn selection through premise-fit rather than serving as legibility-of-genre signals. This is *not* a return to v4.7's permissiveness — the recognition-premise exclusion, the worry-vocabulary inversion, and the re-skin test are all still in force. A v1.1 narrative scene must be plot-shaped at the genre's operational center, not recognition-shaped at the literary-realist register.
...
**Diversity across candidates.** Phases 4, 5, and 6 all include explicit diversity axes. Models produce clustered candidates by default; without explicit axes and a "break the cluster" instruction, "generate 20 diverse plots" reliably returns 20 variations of the same plot. Phase 4's *form* axis is the most important. Under v1.1's calibration, narrative scenes are the default for most genres and not the cluster to break. The cluster the template fights hardest is *document-form clustering* — too many of the candidate pool collapsing into catalogues, dossiers, encyclopedia entries, transcripts, manuals, registers, correspondences, ledgers, after-actions. Document forms are over-represented in the writer-model's training relative to other strange-tail forms (parable-compressions, deep-time montages, ontological reframes, irruptions, world-as-process). When non-narrative-scene plots cluster on document forms, push some toward non-document strange forms.
