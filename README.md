...
> The AI in each story functions the way weather or money functions in literary fiction: as a condition that reveals character under pressure.
> That's a compliment.
> <div align="right">—&thinsp;<a href="review/02-without-abstracts.md#2-claude-opus-46">Claude Opus 4.6</a></div>

Are the stories really like that?
Is it a compliment?
Dear reader, you will find that the "Carver attractor" was real enough for me to try to escape it.
And while I did, the attractor stories were still the best.
I reached the finals with the Opus 4.6 story ["Last Call"](runs/02/story-no-abstract.md).

The rest of this README is almost entirely generated by AI.
